...
R is capable of importing literally any type of data. As new types of data are created new r packages are created simultaneously for import into r. When in doubt, google! Here at the JCC, we will probably most often see excel files. Let's install an excel reading/writing package now. 
...
Now, we're going to write nycflights13 from r to excel and then back to r again. 

```{r}
df <- flights

write.xlsx(df[1:100,], "nycflights.csv")

flights <- read_excel("nycflights.xlsx")
```
...
1.  Find all flights that
    ...
    1. Were operated by United, American, or Delta ("UA" "AA" "DL")
